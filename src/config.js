...
const CONFIG = {
  ...
  AVATAR_BASEPATH: process.env.NODE_ENV === 'production' ? 'https://website.com/avatar/' : 'https://localhost:7134/avatar/',
  UPLOAD_BASEPATH: process.env.NODE_ENV === 'production' ? 'https://website.com/' : 'https://localhost:7134/',
  IMAGES_EXTENSIONS: ['.jpg', '.jpeg', '.tiff', '.tif', '.gif', '.bmp', '.png'],
  VIDEOS_EXTENSIONS: ['.mp4', '.h264', '.wmv', '.wav', '.avi', '.flv', '.mov', '.mkv', '.webm', '.ogg'],
  LOGIN_API_PATH: process.env.NODE_ENV === 'production' ? 'https://website.com/Auth/Login' : 'https://localhost:7134/Auth/Login',
  REFRESH_TOKEN_API_PATH:
    process.env.NODE_ENV === 'production' ? 'https://website.com/Auth/RefreshToken' : 'https://localhost:7134/Auth/RefreshToken',
  LOGOUT_API_PATH: process.env.NODE_ENV === 'production' ? 'https://website.com/Auth/SignOut' : 'https://localhost:7134/Auth/SignOut',
  FRONT_PATH: process.env.NODE_ENV === 'production' ? 'https://website.com' : 'http://localhost:3000',
  DASHBOARD_PATH: process.env.NODE_ENV === 'production' ? 'https://website.com/dashboard' : 'http://localhost:3000/dashboard',
  LOGIN_PATH: process.env.NODE_ENV === 'production' ? 'https://website.com/login' : 'http://localhost:3000/login',
